...
#############################################################################################################################
## Impulse. The discrete time impulse (or discrete time delta function) is potentially the simplest, discrete time signal;
...
def plotGraph():
  ...
  ax = plt.axes()
  #ax.xaxis.grid(True)
  plt.legend((markerline,line2),("f(x) = impulse","g(x) = 0"),loc="upper left")
  plt.show()
