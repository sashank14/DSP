...
def h(x):
   return math.sin(2*x)+math.sin(x+(math.pi/8))
...
def plotGraph():
  ...
  ####### 
  ###########################################################################
  line1, = plt.plot(x_axis,y_axis1,linestyle = "-", color = "b", marker = ".", markerfacecolor = "b", markersize=5,zorder =1) 
  #markerline, stemlines, baseline = plt.stem(x_axis, y_axis1, '-.', bottom=0,zorder =3)
  line2, = plt.plot(x_axis,y_axis2,linestyle = "-", color = "g", marker = ".", markerfacecolor = "g", markersize=5,zorder =2)
  line3, = plt.plot(x_axis,y_axis3,linestyle = "-", color = "r", marker = ".", markerfacecolor = "r", markersize=5,zorder =3)
  #plt.grid(True, which ="major")
  #plt.grid(True, which ="minor")
  ax = plt.axes()
  #ax.xaxis.grid(True)
  plt.legend((line1,line2,line3),("f(x) = sin(2x)","g(x) = sin(x+(pi/8))","h(x) = sin(2x)+sin(x+(pi/8))"),loc="upper left")
  plt.show()
